    ...
    return (
        ...
        <div className="bg-white">
            ...
            <header className="relative bg-white">
                <p className="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Envío gratis por compras superiores a $200.000"</p>
                ...
                <nav aria-label="Top" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="border-b border-gray-200">
                        <div className="flex h-16 items-center">
                            ...
                            <div className="ml-4 flex lg:ml-0 text-purple-500">
                                <a href="#">
                                    <span className="sr-only">Open Flowers</span>
                                    <i className="fa-solid fa-flower"></i> Open Flowers
                                </a>
                            </div>
                                    ...
                                    <div className="flex">
                                        <div className="relative flex">
                                            <button type="button"
                                                    ...
                                                    aria-expanded="false">Ornamentales
                                            </button>
                                        </div>
                                    </div>
                                    <div className="flex">
                                        <div className="relative flex">
                                            <button type="button"
                                                    className="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out"
                                                    aria-expanded="false">Orquideas
                                            </button>
                                        </div>
                                    </div>

                                    <a href="#"
                                       className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Sedes</a>
                                    <a href="#"
                                       className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Aliados</a>
                                </div>
                            </div>
